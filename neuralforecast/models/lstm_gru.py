...
class LSTM_GRU_Hybrid(BaseRecurrent):
    """LSTM_GRU

    LSTM encoder is the 1st layer, GRU encoder is the 2nd layer, with MLP decoder.
    ...
    **Parameters:**<br>
    ...
    `encoder_n_layers`: int=1, number of layers for the LSTM and GRU EACH.<br>
    ...
    def __init__(
        ...
        **trainer_kwargs
        ...
        super(LSTM_GRU_Hybrid, self).__init__(
            h=h,
        ...
        self.lstm_encoder = nn.LSTM(
            ...
            num_layers=encoder_n_layers,  # Set to 1 for single LSTM layer
        ...
        self.gru_encoder = nn.GRU(
            ...
            hidden_size=self.encoder_hidden_size,
            num_layers=encoder_n_layers,  # Set to 1 for single GRU layer
            bias=self.encoder_bias,
            dropout=self.encoder_dropout,
            batch_first=True,
        )
    ...
    def forward(self, windows_batch):
        ...
        # RNN forward
        hidden_state, _ = self.lstm_encoder(encoder_input)  # [B, seq_len, rnn_hidden_state]
        hidden_state, _ = self.gru_encoder(hidden_state)  # [B, seq_len, rnn_hidden_state]
